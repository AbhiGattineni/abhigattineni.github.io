      ...
      <div className="row">
        <div className="col-sm-4 offset-sm-4 mt-3">
          ...
          <div className="text-center mb-4">
            <h6 className="fs-6" style={{ color: "#8892b0" }}>
              I am currently looking for new opportunities in Full Stack/ Front
              End Development, my inbox is always open. Whether you have a
              opportunity or just want to say hi, please connect by clicking
              below button.
            </h6>
          </div>
