                    ...
                    <div className="accordion-item mt-2" style={{ backgroundColor: "#112240", color: "#8892b0" }}>
                        ...
                        <div id="panelsStayOpen-collapseTwo" className="accordion-collapse collapse mt-2" aria-labelledby="panelsStayOpen-headingTwo">
                            <div className="row">
                                <div className="col-sm-8">
                                    <div className="accordion-body">
                                        <strong>My first hands on experience in cyient.</strong> It is shown by default, until the collapse plugin adds the appropriate classes that we use to style each element. These classes control the overall appearance, as well as the showing and hiding via CSS transitions. You can modify any of this with custom CSS or overriding our default variables. It`&apos;`s also worth noting that just about any HTML can go within the <code>.accordion-body</code>, though the transition does limit overflow.
                                    </div>
                                </div>
                                <div className="col-sm-4">
                                    <div className='card text-white' style={{ backgroundColor: "#112240" }}>
                    ...
                    <div className="accordion-item mt-2" style={{ backgroundColor: "#112240", color: "#8892b0" }} >
                        ...
                        <div id="panelsStayOpen-collapseThree" className="accordion-collapse collapse mt-2" aria-labelledby="panelsStayOpen-headingThree">
                            <div className="row">
                                ...
                                <div className="col-sm-8">
                                    <div className="accordion-body">
                                        <strong>HTC is my first business exposure.</strong> It is shown by default, until the collapse plugin adds the appropriate classes that we use to style each element. These classes control the overall appearance, as well as the showing and hiding via CSS transitions. You can modify any of this with custom CSS or overriding our default variables. It`&apos;`s also worth noting that just about any HTML can go within the <code>.accordion-body</code>, though the transition does limit overflow.
                                    </div>
                                </div>
                            </div>
                        </div>
